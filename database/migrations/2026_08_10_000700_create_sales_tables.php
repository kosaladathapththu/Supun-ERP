...
return new class extends Migration
{
    public function up(): void
    {
        ...
        Schema::create('sale_items', function (Blueprint $table) {
            ...
            $table->decimal('margin_percentage', 9, 4)->default(0);
            $table->timestamps();
        });
        ...
        Schema::create('sale_item_serials', function (Blueprint $table) {
            ...
            $table->foreignId('product_serial_number_id')->constrained()->restrictOnDelete();
            $table->primary(['sale_item_id', 'product_serial_number_id']);
            $table->unique('product_serial_number_id');
        });
    }
