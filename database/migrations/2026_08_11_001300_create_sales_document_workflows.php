...
return new class extends Migration
{
    public function up(): void
    {
        ...
        $t->string('status', 30)->default('confirmed')->index();
        $t->decimal('subtotal', 18, 2);
        $t->decimal('discount_amount', 18, 2)->default(0);
        $t->decimal('total_amount', 18, 2);
        $t->text('notes')->nullable();
        ...
        $t->id();
        $t->foreignId('company_id')->constrained()->cascadeOnDelete();
        $t->foreignId('sales_order_id')->constrained()->restrictOnDelete();
        ...
        $t->foreignId('sales_order_item_id')->constrained()->restrictOnDelete();
        $t->foreignId('product_id')->constrained()->restrictOnDelete();
        $t->decimal('quantity', 18, 4);
        $t->timestamps();
        });
