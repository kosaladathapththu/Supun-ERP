...
Route::middleware('auth')->group(function () {
    ...
    Route::middleware('permission:purchases.view')->group(function(){Route::get('payables',[PayableController::class,'index'])->name('payables.index');Route::get('payables/history',[PayableController::class,'history'])->name('payables.history');Route::get('payables/export/excel',[PayableController::class,'exportExcel'])->name('payables.export.excel');Route::get('payables/print',[PayableController::class,'print'])->name('payables.print');Route::get('payables/payment',[PayableController::class,'create'])->name('payables.create');Route::post('payables/payment',[PayableController::class,'store'])->name('payables.store');Route::get('payables/aging',[PayableController::class,'aging'])->name('payables.aging');Route::get('payables/suppliers/{supplier}/ledger',[PayableController::class,'ledger'])->name('payables.ledger');});
