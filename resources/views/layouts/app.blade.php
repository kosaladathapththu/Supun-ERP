...
<aside class="sidebar">
    ...
    <nav class="pb-4">
        ...
        <a class="nav-link {{ request()->routeIs('sales.create')?'active':'' }}" href="{{ route('sales.create') }}"><i class="bi bi-cart3"></i> New Sale / POS</a>
        <a class="nav-link {{ request()->routeIs('sales.index')&&!request('payment_type')?'active':'' }}" href="{{ route('sales.index') }}"><i class="bi bi-receipt"></i> All Sales</a>
        <a class="nav-link {{ request()->routeIs('sales.index')&&request('payment_type')==='cash'?'active':'' }}" href="{{ route('sales.index',['payment_type'=>'cash']) }}"><i class="bi bi-cash"></i> Cash Sales</a>
        <a class="nav-link {{ request()->routeIs('sales.index')&&request('payment_type')==='credit'?'active':'' }}" href="{{ route('sales.index',['payment_type'=>'credit']) }}"><i class="bi bi-credit-card"></i> Credit Sales</a>
        <a class="nav-link {{ request()->routeIs('quotations.*')?'active':'' }}" href="{{ route('quotations.index') }}"><i class="bi bi-file-earmark-text"></i> Quotations</a><a class="nav-link {{ request()->routeIs('sales-orders.*')?'active':'' }}" href="{{ route('sales-orders.index') }}"><i class="bi bi-clipboard-check"></i> Sales Orders</a><a class="nav-link {{ request()->routeIs('delivery-notes.*')?'active':'' }}" href="{{ route('delivery-notes.index') }}"><i class="bi bi-truck"></i> Delivery Notes</a><a class="nav-link {{ request()->routeIs('sale-returns.*')?'active':'' }}" href="{{ route('sale-returns.index') }}"><i class="bi bi-arrow-return-left"></i> Sales Returns</a><a class="nav-link {{ request()->routeIs('purchase-orders.*')?'active':'' }}" href="{{ route('purchase-orders.index') }}"><i class="bi bi-bag"></i> Purchase Orders</a><a class="nav-link {{ request()->routeIs('grn.*')?'active':'' }}" href="{{ route('grn.index') }}"><i class="bi bi-box-arrow-in-down"></i> GRN</a><a class="nav-link {{ request()->routeIs('purchase-returns.*')?'active':'' }}" href="{{ route('purchase-returns.index') }}"><i class="bi bi-arrow-return-right"></i> Purchase Returns</a><a class="nav-link {{ request()->routeIs('stock.*')?'active':'' }}" href="{{ route('stock.index') }}"><i class="bi bi-boxes"></i> Current Stock</a><a class="nav-link {{ request()->routeIs('inventory-operations.*')?'active':'' }}" href="{{ route('inventory-operations.index') }}"><i class="bi bi-arrow-left-right"></i> Inventory Operations</a>
        <div class="nav-section">FINANCE</div>
        <a class="nav-link {{ request()->routeIs('cashier-sessions.*')?'active':'' }}" href="{{ route('cashier-sessions.index') }}"><i class="bi bi-cash-stack"></i> Cashier Closing</a><a class="nav-link {{ request()->routeIs('receivables.*')?'active':'' }}" href="{{ route('receivables.index') }}"><i class="bi bi-cash-coin"></i> Receivables</a><a class="nav-link {{ request()->routeIs('payables.*')?'active':'' }}" href="{{ route('payables.index') }}"><i class="bi bi-wallet2"></i> Payables</a><a class="nav-link {{ request()->routeIs('expenses.*')?'active':'' }}" href="{{ route('expenses.index') }}"><i class="bi bi-receipt"></i> Expenses</a><a class="nav-link {{ request()->routeIs('accounting.*')?'active':'' }}" href="{{ route('accounting.journals') }}"><i class="bi bi-journal-bookmark"></i> Accounting</a><a class="nav-link {{ request()->routeIs('statements.*')?'active':'' }}" href="{{ route('statements.index') }}"><i class="bi bi-file-earmark-bar-graph"></i> Statements</a><a class="nav-link {{ request()->routeIs('reports.*')?'active':'' }}" href="{{ route('reports.index') }}"><i class="bi bi-bar-chart"></i> Reports</a>
        <div class="nav-section">ADMINISTRATION</div><a class="nav-link {{ request()->routeIs('admin.users.*')?'active':'' }}" href="{{ route('admin.users.index') }}"><i class="bi bi-people"></i> Staff Users</a><a class="nav-link {{ request()->routeIs('admin.roles.*')?'active':'' }}" href="{{ route('admin.roles.index') }}"><i class="bi bi-person-lock"></i> Roles & Permissions</a><a class="nav-link {{ request()->routeIs('controls.*')?'active':'' }}" href="{{ route('controls.index') }}"><i class="bi bi-shield-check"></i> Control Center</a>
    </nav>
</aside>
<main class="main">
