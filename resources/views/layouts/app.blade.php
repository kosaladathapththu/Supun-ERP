...
<head>
    ...
    <title>@yield('title', 'Dashboard') · Camy Smart</title>
    <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.3/dist/css/bootstrap.min.css" rel="stylesheet">
    <link href="https://cdn.jsdelivr.net/npm/bootstrap-icons@1.11.3/font/bootstrap-icons.css" rel="stylesheet">
    <style>
        :root{--navy:#0f1f38;--navy2:#162b4b;--blue:#2563eb;--bg:#e9eff6;--surface:#fff;--surface-soft:#f5f8fc;--line:#d5deea;--line-strong:#c2cedd;--muted:#6b7280}
        body{background:var(--bg);font-family:Inter,Segoe UI,sans-serif;color:#172033}.sidebar{width:270px;background:var(--navy);height:100vh;position:fixed;inset:0 auto 0 0;color:#fff;overflow-y:scroll;overscroll-behavior:contain;scrollbar-width:thin;scrollbar-color:#405675 var(--navy)}.sidebar::-webkit-scrollbar{width:7px}.sidebar::-webkit-scrollbar-track{background:var(--navy)}.sidebar::-webkit-scrollbar-thumb{background:#405675;border-radius:8px}.sidebar::-webkit-scrollbar-thumb:hover{background:#587194}.brand{padding:24px;border-bottom:1px solid rgba(255,255,255,.1);position:sticky;top:0;background:var(--navy);z-index:2}.brand-mark{width:42px;height:42px;border-radius:12px;background:#2563eb;display:grid;place-items:center;font-size:21px}.nav-section{font-size:.69rem;letter-spacing:.12em;color:#8291a9;padding:20px 22px 7px}.sidebar .nav-link{color:#c8d2e1;border-radius:9px;margin:2px 12px;padding:10px 12px}.sidebar .nav-link:hover,.sidebar .nav-link.active{color:white;background:var(--navy2)}.sidebar .nav-link i{width:25px}.sidebar .pos-nav{margin:10px 12px 12px;padding:12px;background:#2563eb;color:#fff;font-weight:700;box-shadow:0 7px 18px rgba(37,99,235,.28)}.sidebar .pos-nav:hover,.sidebar .pos-nav.active{background:#1d4ed8;color:#fff}.nav-group-toggle{width:calc(100% - 24px);border:0;text-align:left;display:flex;align-items:center}.nav-group-toggle .chevron{margin-left:auto;width:auto!important;transition:transform .2s}.nav-group-toggle:not(.collapsed) .chevron{transform:rotate(180deg)}.nav-submenu{padding:2px 0 7px}.nav-submenu .nav-link{font-size:.91rem;padding:8px 12px 8px 39px;margin-top:0;margin-bottom:0}.nav-submenu .nav-link i{margin-left:-25px}.main{margin-left:270px;min-height:100vh}.topbar{height:72px;background:#fff;border-bottom:1px solid var(--line);box-shadow:0 2px 8px rgba(15,31,56,.05);display:flex;align-items:center;justify-content:space-between;padding:0 28px;position:sticky;top:0;z-index:10}.content{padding:28px}.card{background:var(--surface);border:1px solid var(--line);box-shadow:0 7px 22px rgba(15,31,56,.08);border-radius:14px}.card-header,.card-footer{background:var(--surface-soft);border-color:var(--line)}.content .card .card{background:var(--surface-soft);border-color:var(--line-strong);box-shadow:0 2px 8px rgba(15,31,56,.05)}.content .section-surface,.content .border.rounded-3{background:var(--surface-soft);border-color:var(--line-strong)!important}.page-title{font-weight:700}.metric-icon{width:46px;height:46px;border-radius:12px;display:grid;place-items:center;background:#eaf1ff;color:#2563eb;font-size:21px}.badge-soft{background:#edf7f1;color:#198754}.table{--bs-table-bg:var(--surface)}.table thead th{font-size:.75rem;text-transform:uppercase;letter-spacing:.04em;color:#536174;background:#eaf0f6;border-bottom:1px solid var(--line-strong)}.table tbody tr:nth-child(even)>*{background:#f8fafc}.table tbody tr:hover>*{background:#eef5ff}.table td{border-color:#dde5ef}.form-control,.form-select{background-color:#fff;border-color:#bdc9d8}.form-control:hover,.form-select:hover{border-color:#93a4b8}.form-control:focus,.form-select:focus{border-color:#6794ee;box-shadow:0 0 0 .2rem rgba(37,99,235,.12)}.nav-pills{display:inline-flex;background:#edf2f7;border:1px solid var(--line);padding:5px;border-radius:10px;gap:3px}.nav-pills .nav-link{border-radius:7px}.btn-primary{background:#2563eb;border-color:#2563eb}.btn-light{background:#f3f6fa;border-color:var(--line)}.coming{opacity:.45;pointer-events:none}.alert{border:1px solid rgba(0,0,0,.08);border-radius:12px;box-shadow:0 3px 10px rgba(15,31,56,.04)}@media(max-width:991px){.sidebar{position:relative;width:100%;height:auto;max-height:none;overflow:visible}.main{margin-left:0}.topbar{position:relative}}
        .brand{padding:18px 20px}.brand-mark{width:62px;height:62px;object-fit:contain;flex:0 0 auto;background:transparent;border-radius:0}
    </style>
    <style>
...
<body>
<aside class="sidebar">
    <div class="brand d-flex align-items-center gap-3"><img class="brand-mark" src="{{ asset('images/camy-smart-logo.png') }}" alt="Camy Smart logo"><div><div class="fw-bold">Camy Smart</div><small class="text-white-50">Supun Group of Companies</small></div></div>
    <nav class="pb-4" id="sidebarMenu">
        @php
            ...
            $financeOpen=request()->routeIs('cashier-sessions.*','receivables.*','payables.*','salaries.*','expenses.*','accounting.accounts','accounting.ledger','accounting.journals','accounting.show');
