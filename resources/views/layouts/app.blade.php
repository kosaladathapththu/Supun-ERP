...
<head>
    ...
    <title>@yield('title', 'Dashboard') · Fuji Industries</title>
...
<body>
<aside class="sidebar">
    <div class="brand d-flex align-items-center gap-3"><div class="brand-mark"><i class="bi bi-cpu"></i></div><div><div class="fw-bold">Fuji</div><small class="text-white-50">Fuji Industries</small></div></div>
