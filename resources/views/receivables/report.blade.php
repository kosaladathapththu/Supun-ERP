...
@foreach([['Total credit sales',$report['totals']['invoiced'],'#17396b'],['Total collected',$report['totals']['received'],'#17894c'],['Current receivable',$report['totals']['current_receivable'],'#d92d3a']] as [$label,$value,$colour])
...
<thead><tr><th>Code</th><th>Customer</th><th class="text-end">Total invoiced</th><th class="text-end">Total received</th><th class="text-end">Invoice outstanding</th><th class="text-end">Advance</th><th class="text-end">Current receivable</th></tr></thead>
...
<table class="table report-money">
<thead><tr><th>Receipt</th><th>Date</th><th>Customer</th><th>Method</th><th>Reference</th><th class="text-end">Amount</th><th class="text-end">Available advance</th></tr></thead>
